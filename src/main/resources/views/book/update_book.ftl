    ...
    <div class="layui-form-item layui-row">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <textarea name="bookPic" value="${(bookInfo.bookPic)!}" id="base64" style="display: none; width: 100%;height: 30em;"></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea  name="bookDescription" value="${(bookInfo.bookDescription)!}" placeholder="请输入内容" class="layui-textarea"></textarea>
            </div>
        </div>
