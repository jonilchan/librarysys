...
//                //如果为视图
//                //判断是否为参数异常
//                if(e instanceof top.upstudy.crm.exceptions.ParamsException){
//                    top.upstudy.crm.exceptions.ParamsException PE = (top.upstudy.crm.exceptions.ParamsException) e;
//                    mv.addObject("msg",PE.getMsg());
//                    mv.addObject("code",PE.getCode());
//                }
//                //是否为认证异常
//                else  if(e instanceof top.upstudy.crm.exceptions.AuthException){
//                    top.upstudy.crm.exceptions.AuthException ae = (top.upstudy.crm.exceptions.AuthException) e;
